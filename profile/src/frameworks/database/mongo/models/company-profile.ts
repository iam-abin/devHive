...
interface CompanyProfileModel extends mongoose.Model<ICompanyDocument> {
	buildCompany(attributes: ICompanyAttributes): ICompanyDocument;
}

// 5.In Mongoose, you can also add custom functions to a model using statics.
companySchema.statics.buildCompany = (attributes: ICompanyAttributes) => {
...
const CompanyProfileModel = mongoose.model<ICompanyDocument, CompanyProfileModel>(
	"Company",
	companySchema
);
