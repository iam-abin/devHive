...
import passwordControllers from "./passwordUpdate";
import jwtRefreshControllers from "./jwtRefresh"


export { candidateControllers, recruiterControllers, adminControllers, otpControllers, passwordControllers, jwtRefreshControllers };
