...
export const adminSigninApi = async (data: any): Promise<any> => {
	// return new Promise(async (resolve, reject)=>{
		// try {
			const response: any = await adminApiCalls("post", authApiUrlConfig.signinAdminUrl, data);
...
export const adminSignoutApi = async (): Promise<any> => {
	...
	// try {
		const response: any = await adminApiCalls("post", authApiUrlConfig.signoutAdminUrl);
		console.log("response is",response.data);
