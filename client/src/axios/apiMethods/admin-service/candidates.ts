...
export const getAllCandidatesApi = async (): Promise<any> => {
    ...
    // try {
		const response: any = await adminApiCalls("get", adminApiUrlConfig.getAllCandidatesUrl);
...
export const blockUnblockCandidateApi = async (userId: string): Promise<any> => {
    console.log("getAllCandidatesApi");
    // try {
		const response: any = await adminApiCalls("get", adminApiUrlConfig.blockUnblockCandidateUrl(userId));
		console.log("response is",response);
...
export const viewCandidateProfileDetailsApi = async (userId: any): Promise<any> => {
    // try {
		const response: any = await adminApiCalls("get", adminApiUrlConfig.viewCandidateProfileDetailsUrl(userId));
		console.log("response is",response);
