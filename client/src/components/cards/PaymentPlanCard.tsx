...
const PaymentPlanCard: React.FC<{makePayment: any, candidateProfileData: any, planData: any}> = ({makePayment, candidateProfileData, planData}) => {
  return (
    ...
    >
        {planData?.features.length>0? planData.features.map((item: string, index: number)=><li key={index} className="flex items-center space-x-3">
            {/* Icon */}
            <svg
