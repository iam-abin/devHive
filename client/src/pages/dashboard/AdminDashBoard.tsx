...
import {
    getAllCardsDetailsApi,
    getGraphDataApi,
} from "../../axios/apiMethods/admin-service/admin-dashboard";
import { formatCurrency } from "../../utils/currency-format";
import DashboardCardAdminShimmer from "../../components/shimmer/dashboard/DashboardCardAdminShimmer";
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-4  md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                {!data.recruiterCount ? (
                    <DashboardCardAdminShimmer />
                ) : (
                    <DashBoardCard
                        title="Recruiters"
                        total={data.recruiterCount}
                    >
                        <svg
