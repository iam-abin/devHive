...
// import { getAllRecruiterDashboardCardsDetailsApi } from "../../axios/apiMethods/jobs-service/jobs";
import { getRecruiterDashboadApi } from "../../axios/apiMethods/jobs-service/jobs";
...
const RecruiterDashBoardPage: React.FC = () => {
	...
	// 		const data = await getRecruiterDashboadApi()
	...
	return (
		<div className="p-5">
			<div className=" grid grid-cols-1 gap-4  md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
				<DashBoardCard title="Recruiters" total={data.recruiterCount}>
					<svg
				...
				<DashBoardCard title="Candidates" total={data.candidateCount}>
					<svg
						className="fill-primary dark:fill-white"
						width="20"
						height="22"
				...
				<DashBoardCard title="Jobs" total={data.jobCount}>
					<svg
						className="fill-primary dark:fill-white"
						width="22"
						height="22"
