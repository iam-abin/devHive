		...
		<>
			<Suspense fallback={<Loading />}>
				<Routes>
					...
					<Route path="/" element={isCandidateLoggedIn? <CandidateLayout />: <Navigate to={"/candidate/landing"} />} >
					{/* <Route
            index={true}
            element={
              token?.access ? (
          ...
          /> */}
						...
						{/* <Route index={true} element={isCandidateLoggedIn? <LandingPage />: <Navigate to={"/candidate/landing"} />} /> */}
